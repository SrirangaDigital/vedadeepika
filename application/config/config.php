...
define('BASE_URL', 'http://localhost:8080/vedadeepika/');
...
define('PHY_BASE_URL', '/Users/sriranga/websites/vedadeepika/');
...
// Database Constants
define('DB_PREFIX', 'veda');
define('DB_HOST', 'localhost');
define('DB_NAME', 'hits');
define('vedaHITS_USER', 'root');
define('vedaHITS_PASSWORD', 'Mysql@123');
?>
